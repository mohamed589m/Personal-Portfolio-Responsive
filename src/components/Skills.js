...
export const Skills = () => {
  ...
  return (
    <section className="skills p-md-5 p-1 " id="skills">
      <Container>
        <Row>
          <Col>
            <div className="skill-box">
              ...
              <div>
                <p align="center">
                  <div className="d-flex justify-content-md-around justify-content-center gap-3 px-md-5 mb-5 ">
                    <a
                    ...
                    <a href="https://tanstack.com/query/latest">
                      <svg
                        ...
                        fill="none"
                        viewBox="0 0 24 24"
                        id="React-Query-Icon--Streamline-Svg-Logos"
                        height="40"
                        width="40"
                      >
                        <desc>
                          React Query Icon Streamline Icon:
                  ...
                  <div className="d-flex justify-content-md-around justify-content-center gap-3 px-md-5 mb-5">
                    ...
                    <a href="https://sequelize.org/">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M69.9114 160.804V131.798H70.6234L95.8608 145.557V174.203L69.9146 160.804"
                          fill="#2379BD"
                        />
                        <path
                          d="M95.0677 117.292L69.9114 131.798L95.443 146.355L120.544 132.008L95.0127 117.241"
                          fill="#03AFEF"
                        />
                        <path
                        ...
                        />
                        <path
                          d="M69.9114 122.199V93.1899H70.6234L95.8608 106.949V135.595L69.9146 122.196"
                          fill="#2379BD"
                        />
                        <path
                          d="M95.0677 78.6328L69.9114 92.7967L95.443 107.114L120.544 93.1056L95.0127 78.686"
                          fill="#03AFEF"
                        />
                        <path
                    ...
                    <a href="https://supabase.com/">
                      ...
                      >
                        ...
                        <g clip-path="url(#clip0_147_961)">
                          <path
                            fill="url(#paint0_linear_147_961)"
                            d="M144.757 223.193C139.696 229.566 129.434 226.074 129.312 217.936L127.529 98.9075H207.564C222.06 98.9075 230.145 115.651 221.131 127.004L144.757 223.193Z"
                          />
                          <path
                            fill="url(#paint1_linear_147_961)"
                            fill-opacity=".2"
                            d="M144.757 223.193C139.696 229.566 129.434 226.074 129.312 217.936L127.529 98.9075H207.564C222.06 98.9075 230.145 115.651 221.131 127.004L144.757 223.193Z"
                          />
                          <path
                            fill="#3ECF8E"
                            d="M112.207 31.6655C117.268 25.2914 127.53 28.784 127.652 36.9221L128.434 155.951H49.4003C34.9034 155.951 26.8182 139.207 35.8328 127.854L112.207 31.6655Z"
                          />
                        </g>
                        <defs>
                          <linearGradient
                            id="paint0_linear_147_961"
                            x1="127.529"
                            x2="198.661"
                            y1="125.299"
                            y2="155.132"
                  ...
                  <div className="d-flex justify-content-md-around justify-content-center gap-3 px-md-5 mb-5">
                    ...
                    <a href="https://socket.io/">
                      <svg
                        ...
                        fill="none"
                        viewBox="0 0 24 24"
                        id="Socket.Io--Streamline-Svg-Logos"
                        height="40"
                        width="40"
                      >
                        <desc>
                        ...
                        <path
                          fill="#010101"
                          d="M9.024175 0.632665c3.0406 -0.77978675 6.401 -0.3253775 9.08255 1.3295675C21.48395 3.981825 23.688675 7.802225 23.744775 11.734825c0.123425 3.971875 -1.946675 7.910075 -5.2734 10.069925 -3.702575 2.490825 -8.8245 2.5862 -12.605625 0.218775C2.01169 19.72345 -0.23791225 15.083975 0.339915 10.62965 0.805545 5.922875 4.440825 1.7714925 9.024175 0.632665Z"
                          stroke-width="0.25"
                        ></path>
                        <path
                          fill="#ffffff"
                          d="M8.558675 2.55685c5.744625 -2.3001025 12.790775 1.94665 13.385425 8.106425 0.92565 5.54265 -3.67455 11.175075 -9.290125 11.337775C7.31325 22.534 2.152075 18.00675 2.000605 12.6436 1.602295 8.301475 4.4634 3.993 8.558675 2.55685Z"
                          stroke-width="0.25"
                        ></path>
                        <path
                          fill="#010101"
                          d="M9.136475 11.403875c2.574975 -2.10375 5.093875 -4.280425 7.72495 -6.32245 -1.38005 2.120575 -2.799375 4.2131 -4.17945 6.333675 -1.1837 0.0056 -2.3674 0.0056 -3.5455 -0.011225Z"
                          stroke-width="0.25"
                        ></path>
                        <path
                          fill="#010101"
                          d="M11.312975 12.576425c1.189325 0 2.373025 0 3.55675 0.016825 -2.591825 2.092525 -5.099475 4.286025 -7.736175 6.32245 1.38005 -2.120575 2.799375 -4.2187 4.179425 -6.339275Z"
                          stroke-width="0.25"
                        ></path>
                      </svg>
                    </a>
